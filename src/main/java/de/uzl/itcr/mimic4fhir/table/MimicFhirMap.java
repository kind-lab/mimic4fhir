...
public class MimicFhirMap {
	...
	public void createMap() {
		...
		map.put(MimicFhirTable.CONDITION_ED, Condition.class);
		map.put(MimicFhirTable.ENCOUNTER, Encounter.class);
		map.put(MimicFhirTable.ENCOUNTER_ED, Encounter.class);
		...
		map.put(MimicFhirTable.MEDICATION_DISPENSE_ED, MedicationDispense.class);
		map.put(MimicFhirTable.MEDICATION_REQUEST, MedicationRequest.class);
		map.put(MimicFhirTable.MEDICATION_STATEMENT_ED, MedicationStatement.class);
		...
		map.put(MimicFhirTable.OBSERVATION_ED, Observation.class);
		...
		map.put(MimicFhirTable.OBSERVATION_VITAL_SIGNS, Observation.class);
		map.put(MimicFhirTable.OBSERVATION_MICRO_TEST, Observation.class);
		...
		map.put(MimicFhirTable.PROCEDURE_ED, Procedure.class);
